...
QT_MOC_LITERAL(3, 17, 9) // "StartTest"

    },
    "Evaluation\0Exit\0\0StartTest"
};
...
const QMetaObject Evaluation::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Evaluation.data,
      qt_meta_data_Evaluation,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Evaluation::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Evaluation.stringdata0))
        return static_cast<void*>(const_cast< Evaluation*>(this));
